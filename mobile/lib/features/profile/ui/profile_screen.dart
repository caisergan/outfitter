...
class ProfileScreen extends ConsumerWidget {
          ...
          child: ListView(
            ...
            children: [
              ...
              ProfileOutfitSection(
                ...
                onToggleLike: (id) =>
                    ref.read(profileNotifierProvider.notifier).toggleLikedOutfit(id),
              ),
              const SizedBox(height: 28),
              ProfileOutfitSection(
                title: 'Liked Outfits',
                emptyTitle: 'No liked outfits',
                emptyMessage: 'Tap the heart on saved looks to collect favorites.',
  ...
  Future<void> _openOutfit(
    ...
    await ref.read(profileNotifierProvider.notifier).markRecentlyViewed(outfit.id);
